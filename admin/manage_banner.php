...
if(isset($_GET['id']) && $_GET['id']>0){
    ...
    $image_status='';  //when updating image value is blank
}
...
if(isset($_POST['submit'])){
	...
	if($id==''){
        ...
        if($_FILES['image']['type'] == ''){//if user doesn't select any image
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control" placeholder="Image" name="image" required <?php echo $image_status?>>
